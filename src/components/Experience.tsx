    ...
    >
      ...
      <div className="lg:w-1/2 p-8">
        <div className="py-6 lg:py-12 flex flex-col gap-4">
          <p className="text-sm tracking-[4px] font-mono text-orange-400">2014 - 2025</p>
        ...
        <div className="mt-6 lg:mt-14 w-full h-[1000px] border-l-[6px] border-l-sky-600 border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="Factoría F5 (Oct - May)"
            place="MADRID"
            des="A comprehensive 8-month bootcamp which covered the latest skills in web development, by tackling front-end and back-end projects."
          />
          <ResumeCard
          ...
          <ResumeCard
            ...
            place="2:1"
            des="Specialised in French and Spanish. Through immersive study, cultural exploration, and linguistic analysis, I developed a deep understanding of the intricacies of  language."
          />
        </div>
      </div>
      ...
      <div className="lg:w-1/2 p-8">
        <div className="py-6 lg:py-12 flex flex-col gap-4">
          <p className="text-sm tracking-[4px] font-mono text-orange-400">2020 - 2025</p>
